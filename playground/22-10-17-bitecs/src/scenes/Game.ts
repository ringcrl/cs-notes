...
export default class Game extends Phaser.Scene {
  ...
  preload () {
    const tankBlue = new URL('../assets/tank_blue.png', import.meta.url).href
    this.load.image('tank-blue', tankBlue)

    const tankGreen = new URL('../assets/tank_green.png', import.meta.url).href
    this.load.image('tank-green', tankGreen)

    const tankRed = new URL('../assets/tank_green.png', import.meta.url).href
    this.load.image('tank-red', tankRed)
  }
