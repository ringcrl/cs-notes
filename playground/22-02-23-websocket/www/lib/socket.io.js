...
(function (global, factory) {
  ...
  function pathNames (obj, path) {
    const regx = /\/{2,9}/g
    let names = path.replace(regx, '/').split('/')
  ...
  const encodePayload = function encodePayload (packets, callback) {
    ...
    let encodedPackets = new Array(length)
    let count = 0
  ...
  const Transport = /* #__PURE__ */(function (_Emitter) {
    ...
    _createClass(Transport, [{
      ...
      value: function onError (msg, desc) {
        let err = new Error(msg) // @ts-ignore
  ...
  var Request = /* #__PURE__ */(function (_Emitter) {
    ...
    let _super2 = _createSuper(Request)
    ...
    _createClass(Request, [{
      ...
      value: function create () {
        ...
        let xhr = this.xhr = new XMLHttpRequest$1(opts)
  ...
  const nextTick = (function () {
    let isPromiseAvailable = typeof Promise === 'function' && typeof Promise.resolve === 'function';
  ...
  const Socket$1 = /* #__PURE__ */(function (_Emitter) {
    ...
    function Socket (uri) {
      ...
      installTimerFunctions(_assertThisInitialized(_this), opts)
      _this.secure = opts.secure != null ? opts.secure : typeof location !== 'undefined' && 'https:' === location.protocol
    ...
    _createClass(Socket, [{
      ...
      value: function createTransport (name) {
        let query = clone(this.opts.query) // append engine.io protocol identifier
      ...
      value: function probe (name) {
        ...
        var onTransportOpen = function onTransportOpen () {
          ...
          transport.once('packet', function (msg) {
            ...
            if ('pong' === msg.type && 'probe' === msg.data) {
              ...
              let err = new Error('probe error') // @ts-ignore
        ...
        let onerror = function onerror (err) {
          let error = new Error('probe error: ' + err) // @ts-ignore
      ...
      value: function close () {
        ...
        let cleanupAndClose = function cleanupAndClose () {
        ...
        let waitForUpgrade = function waitForUpgrade () {
  ...
  const Encoder = /* #__PURE__ */(function () {
    ...
    _createClass(Encoder, [{
      ...
      value: function encodeAsBinary (obj) {
        let deconstruction = deconstructPacket(obj)
  ...
  const Decoder = /* #__PURE__ */(function (_Emitter) {
    ...
    _createClass(Decoder, [{
      ...
      value: function decodeString (str) {
        ...
        if (str.charAt(++i)) {
          let payload = tryParse(str.substr(i))
  ...
  const Socket = /* #__PURE__ */(function (_Emitter) {
    ...
    _createClass(Socket, [{
      ...
      value: function _registerAckCallback (id, ack) {
        ...
        let timer = this.io.setTimeoutFn(function () {
    ...
    _createClass(Manager, [{
      ...
      value: function open (fn) {
        ...
        if (this._timeout !== false) {
          ...
          let timer = this.setTimeoutFn(function () {
            openSubDestroy()
