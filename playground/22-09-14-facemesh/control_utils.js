...
*/
  ...
  function ja(a) {
      this.next = function(b) {
          C(a.g);
          a.g.h ? b = G(a, a.g.h.next, b, a.g.m) : (a.g.m(b),
          b = H(a));
          return b
      }
      ;
      this.throw = function(b) {
          C(a.g);
          a.g.h ? b = G(a, a.g.h["throw"], b, a.g.m) : (D(a.g, b),
          b = H(a));
          return b
      }
      ;
  ...
  function T(a, b) {
      for (var c = v(a.g.options), d = c.next(); !d.done; d = c.next()) {
          ...
          if (d.value === b && !f.classList.contains("selected"))
              return (b = a.options.querySelector(".selected")) && b.classList.remove("selected"),
  ...
  V.prototype.tick = function() {
      ...
      1 <= a - this.i && (ra(this, this.counter),
      this.i = a,
      this.counter = 0);
      ++this.counter
  }
  ...
  W.prototype.create = function(a, b, c) {
      ...
      g.type = "range";
      b.range ? (g.min = "" + b.range[0],
      g.max = "" + b.range[1],
      g.step = void 0 === b.step ? "any" : "" + b.step) : b.discrete && (g.min = "0",
      ...
      g.onchange = function() {
          ...
          d.g.discrete && (e = Object.keys(d.g.discrete)[e],
  ...
  function va(a) {
      return L(a, function c() {
          ...
          return I(c, function(k) {
              if (1 == k.g)
                  return F(k, navigator.mediaDevices.getUserMedia({
                      video: !0
                  }), 2);
              if (3 != k.g)
              ...
              for (e = g.next(); !e.done; e = g.next())
                  h = e.value,
                  "" !== h.label && "videoinput" === h.kind && f.push({
                      label: h.label,
                      deviceId: h.deviceId
                  });
              return k.return(f)
  ...
  Y.prototype.tick = function() {
      var a = this
        , b = null;
      this.j && (this.video.paused || this.video.currentTime === this.A || (this.m || (wa(this, this.video.currentTime / this.video.duration),
      this.i.time.textContent = xa(this.video.currentTime)),
      this.A = this.video.currentTime,
      b = this.g.onFrame ? this.g.onFrame(this.video, {
  ...
  function Ea(a, b) {
      return L(a, function d() {
          ...
          return I(d, function(g) {
              1 == g.g ? g = F(g, za(f), 2) : 3 != g.g ? f.g.onSourceChanged ? g = F(g, f.g.onSourceChanged(b.label, b.type), 3) : (g.g = 3,
              g = void 0) : g = F(g, b.start(), 0);
              return g
          })
      })
  }
          ...
          return L(a, function f() {
              ...
              return I(f, function(n) {
                  if ((g = c.files) && 0 < g.length) {
                      ...
                      k = u.toString();
                      "image" === h ? (qa(l.o, g[0].name),
                      Da(l, k)) : "video" === h && Ca(l, k)
                  }
                  n.g = 0
              })
          })
  ...
  Y.prototype.create = function(a, b, c) {
      ...
      Aa(this).then(function(e) {
          ...
          Ja(d, f);
          0 < d.l.length && (e = d.l[0],
          T(d.o, e.label) || qa(d.o),
          e.start())
      })
  }
  ;
  function Ja(a, b) {
      ...
      ;
      h.onclick = function() {
          a.video.paused ? (a.video.play(),
          h.src = c) : (a.video.pause(),
          h.src = d)
      }
      ;
      a.D = function() {
  ...
  La.prototype.update = function() {
      this.options[this.h.field] ? (this.value.textContent = "Yes",
      this.g.classList.add("yes"),
      this.g.classList.remove("no")) : (this.value.textContent = "No",
